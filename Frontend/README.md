# Fish or Fiction Frontend

A modern React application for the Fish or Fiction game. Built with React, TypeScript, Vite, Material-UI, Tailwind CSS, and Apollo GraphQL.
